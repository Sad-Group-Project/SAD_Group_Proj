<template>
  <div class="container mt-3">
    ...
    <div class="row">
      <div class="col-md-6">
        <h2 class="text-center">Popular Stocks</h2>
        <div class="row row-cols-1 row-cols-md-2 g-3 mt-3 align-items-stretch">
          <div class="col" v-for="(stock, index) in popularStocks" :key="index">
      ...
      <div class="col-md-6">
        ...
        <template v-if="trackedStocks && trackedStocks.length">
          <div class="row row-cols-1 row-cols-md-2 g-3 mt-3 align-items-stretch">
            <div class="col" v-for="(stock, index) in trackedStocks" :key="index">
              <div class="card h-100">
                <div class="card-body d-flex flex-column justify-content-between">
                  <h5 class="card-title">{{ stock.name }}</h5>
                  <div class="chart-container">
        ...
        <template v-else>
          ...
          >
            ...
            <button class="btn btn-primary">Add some Now!</button>
          </div>
        </template>
      </div>
    </div>
